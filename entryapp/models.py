...
class Shop(models.Model):
    ...
    notification_start_time = models.TimeField(null=True, blank=True, help_text="Bildirim başlangıç saati")
    notification_end_time = models.TimeField(null=True, blank=True, help_text="Bildirim bitiş saati")
